<?php 
	...
	list( $itemid, $item_type, $item_postedby, $item_posted, $item_supplier, $item_price, $item_unit, $item_img, $item_updated, $item_updatedby) = $database->get_row( $js_db_query );
}
	  ...
	  <div class="innerblock pad-2">
        <div class="block-4 col-3">
          ...
          <br><hr>
				...
				<h2>Item: <?php echo $item_quantity.' '.js_type_item($item_type).'s' ?></h2>
